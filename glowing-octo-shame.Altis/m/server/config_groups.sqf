...
if(configName(LIB_cfgVeh >> "B_Soldier_F") != "")then{
	...
	if(!_woodland && _deserted)then{
		_west=_west+[
			...
			// колесный
			[[[["B_soldier_AR_F","B_soldier_LAT_F","B_MRAP_01_gmg_F"],[[5,-5,0],[-5,-5,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE"]]],0.5],
			[[[["B_soldier_AT_F","B_soldier_AT_F","B_soldier_AAT_F","B_MRAP_01_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["B_soldier_AA_F","B_soldier_AA_F","B_soldier_AAA_F","B_MRAP_01_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			...
			[[[["B_soldier_SL_F","B_soldier_SL_F","B_soldier_TL_F","B_soldier_TL_F","B_soldier_F","B_soldier_LAT_F","B_soldier_M_F","B_soldier_AR_F","B_soldier_A_F","B_medic_F","B_soldier_F","B_soldier_LAT_F","B_soldier_M_F","B_soldier_AR_F","B_soldier_A_F","B_medic_F","B_Truck_01_transport_F"],[[5,0,0],[5,-2,0],[5,-4,0],[5,-6,0],[5,-8,0],[5,-10,0],[5,-12,0],[5,-14,0],[-5,0,0],[-5,-2,0],[-5,-4,0],[-5,-6,0],[-5,-8,0],[-5,-10,0],[-5,-12,0],[-5,-14,0],[0,0,0]],["LIEUTENANT","LIEUTENANT","SERGEANT","SERGEANT","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
	...
	if(!_woodland && _deserted)then{
		_east=_east+[
			...
			// колесный
			[[[["O_soldier_AR_F","O_soldier_AT_F","O_MRAP_02_GMG_F"],[[-5,-5,0],[-5,-5,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_soldier_AT_F","O_soldier_AT_F","O_soldier_AAT_F","O_MRAP_02_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_soldier_AA_F","O_soldier_AA_F","O_soldier_AAA_F","O_MRAP_02_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_soldier_TL_F","O_support_MG_F","O_support_AMG_F","O_MRAP_02_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["SERGEANT","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_soldier_TL_F","O_support_GMG_F","O_support_AMG_F","O_MRAP_02_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["SERGEANT","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_soldier_TL_F","O_support_Mort_F","O_support_AMort_F","O_MRAP_02_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["SERGEANT","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_soldier_SL_F","O_soldier_TL_F","O_soldier_TL_F","O_soldier_F","O_soldier_LAT_F","O_soldier_M_F","O_soldier_AR_F","O_soldier_A_F","O_medic_F","O_soldier_AR_F","O_soldier_GL_F","O_soldier_LAT_F","O_Truck_03_transport_F"],[[5,0,0],[5,-2,0],[5,-4,0],[5,-6,0],[5,-8,0],[5,-10,0],[-5,-8,0],[-5,-10,0],[-5,0,0],[-5,-2,0],[-5,-4,0],[-5,-6,0],[0,0,0]],["LIEUTENANT","SERGEANT","SERGEANT","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			// бтр
	...
	if(true)then{
		_guer=_guer+[
			...
			// колесный
			[[[["I_Soldier_AR_F","I_Soldier_LAT_F","I_MRAP_03_gmg_F"],[[5,-5,0],[-5,-5,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["I_Soldier_AT_F","I_Soldier_AAT_F","I_MRAP_03_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["I_Soldier_AA_F","I_Soldier_AAA_F","I_MRAP_03_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["I_support_MG_F","I_support_AMG_F","I_MRAP_03_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["I_support_GMG_F","I_support_AMG_F","I_MRAP_03_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["I_support_Mort_F","I_support_AMort_F","I_MRAP_03_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
...
if(configName(LIB_cfgVeh >> "B_T_soldier_F") != "")then{
	if(_woodland && !_deserted)then{
		...
		_west=_west+[
			...
			// колесный
			[[[["B_T_soldier_AR_F","B_T_soldier_LAT_F","B_T_MRAP_01_gmg_F"],[[5,-5,0],[-5,-5,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE"]]],0.5],
			[[[["B_T_soldier_AT_F","B_T_soldier_AT_F","B_T_soldier_AAT_F","B_T_MRAP_01_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["B_T_soldier_AA_F","B_T_soldier_AA_F","B_T_soldier_AAA_F","B_T_MRAP_01_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			...
			[[[["B_T_soldier_SL_F","B_T_soldier_SL_F","B_T_soldier_TL_F","B_T_soldier_TL_F","B_T_soldier_F","B_T_soldier_LAT_F","B_T_soldier_M_F","B_T_soldier_AR_F","B_T_soldier_A_F","B_T_medic_F","B_T_soldier_F","B_T_soldier_LAT_F","B_T_soldier_M_F","B_T_soldier_AR_F","B_T_soldier_A_F","B_T_medic_F","B_T_Truck_01_transport_F"],[[5,0,0],[5,-2,0],[5,-4,0],[5,-6,0],[5,-8,0],[5,-10,0],[5,-12,0],[5,-14,0],[-5,0,0],[-5,-2,0],[-5,-4,0],[-5,-6,0],[-5,-8,0],[-5,-10,0],[-5,-12,0],[-5,-14,0],[0,0,0]],["LIEUTENANT","LIEUTENANT","SERGEANT","SERGEANT","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["B_CTRG_Soldier_M_tna_F","B_CTRG_Soldier_Medic_tna_F","B_CTRG_Soldier_AR_tna_F","B_CTRG_Soldier_LAT_tna_F","B_CTRG_Soldier_JTAC_tna_F","B_CTRG_Soldier_Exp_tna_F","B_T_LSV_01_unarmed_CTRG_F"],[[5,-5,0],[-5,-5,0],[10,-10,0],[-10,-10,0],[15,-15,0],[-15,-15,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["B_CTRG_Soldier_Medic_tna_F","B_CTRG_Soldier_M_tna_F","B_CTRG_Soldier_AR_tna_F","B_CTRG_Soldier_LAT_tna_F","B_T_LSV_01_armed_CTRG_F"],[[5,-5,0],[-5,-5,0],[10,-10,0],[-10,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
	...
	if(_woodland && !_deserted)then{
		...
		_east=_east+[
			...
			// колесный
			[[[["O_T_soldier_AR_F","O_T_soldier_AT_F","O_T_MRAP_02_gmg_ghex_F"],[[5,-5,0],[-5,-5,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_T_soldier_AT_F","O_T_soldier_AT_F","O_T_soldier_AAT_F","O_T_MRAP_02_ghex_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_T_soldier_AA_F","O_T_soldier_AA_F","O_T_soldier_AAA_F","O_T_MRAP_02_ghex_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["CORPORAL","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_T_soldier_TL_F","O_T_support_MG_F","O_T_support_AMG_F","O_T_MRAP_02_ghex_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["SERGEANT","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_T_soldier_TL_F","O_T_support_GMG_F","O_T_support_AMG_F","O_T_MRAP_02_ghex_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["SERGEANT","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			[[[["O_T_soldier_TL_F","O_T_support_Mort_F","O_T_support_AMort_F","O_T_MRAP_02_ghex_F"],[[5,-5,0],[-5,-5,0],[0,-10,0],[0,0,0]],["SERGEANT","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			...
			[[[["O_T_soldier_SL_F","O_T_soldier_TL_F","O_T_soldier_TL_F","O_T_soldier_F","O_T_soldier_LAT_F","O_T_soldier_M_F","O_T_soldier_AR_F","O_T_soldier_A_F","O_T_medic_F","O_T_soldier_AR_F","O_T_soldier_GL_F","O_T_soldier_LAT_F","O_T_Truck_03_transport_ghex_F"],[[5,0,0],[5,-2,0],[5,-4,0],[5,-6,0],[5,-8,0],[5,-10,0],[-5,-8,0],[-5,-10,0],[-5,0,0],[-5,-2,0],[-5,-4,0],[-5,-6,0],[0,0,0]],["LIEUTENANT","SERGEANT","SERGEANT","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE","PRIVATE"]]],0.5],
			// бтр
